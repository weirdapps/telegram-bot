...
| §5 Configuration     | 7 new env vars: `VOICE_BRIDGE_GCP_KEY_PATH`, `GOOGLE_CLOUD_PROJECT`, `VOICE_BRIDGE_TTS_VOICE_EL`, `VOICE_BRIDGE_TTS_VOICE_EN`, `VOICE_BRIDGE_MAX_AUDIO_SECONDS`, `VOICE_BRIDGE_REJECT_ABOVE_SECONDS`, `VOICE_BRIDGE_KEEP_AUDIO_FILES` |
